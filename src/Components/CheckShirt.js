    ...
    <Suitgrid>
        ...
        <Type>
          <Content>
            <h1>CHECKS</h1>
            <p>
            Checkered shirts feature a pattern of intersecting horizontal and vertical lines, creating squares or rectangles. They offer a bold, classic look and can be casual or semi-formal, adding texture and style to any outfit.                 </p>
        ...
        <PatternShirtCard pattern="checks" />
    </Suitgrid>
  )
}
